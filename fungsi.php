...
// menambah data user
function tambahUser($tabel,$nama,$username,$password) {
	include('config.php');
	$md5 = md5($password);
	$query 	= "INSERT INTO $tabel (nama, username, password) VALUES ('$nama', '$username', '$md5')";
	$tambah	= mysqli_query($koneksi, $query);
...
function showTabelPerbandingan($jenis,$kriteria) {
	...
	<br><br><input class="ui submit primary button" type="submit" name="submit" value="PROSES">
	</form>
